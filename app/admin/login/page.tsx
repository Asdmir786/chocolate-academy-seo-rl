        ...
        <div className="w-full max-w-md px-4">
          <Card className="border-[#3c2415]/20 shadow-lg">
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">Sign in to manage Chocolate Academy content</CardDescription>
            </CardHeader>
            <CardContent>
              {error && (
              ...
              <form onSubmit={handleLogin}>
                <div className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-[#3c2415] hover:bg-[#5a3a28]" disabled={isLoading}>
                    {isLoading ? (
            ...
            <CardFooter className="text-center">
              <p className="text-xs text-muted-foreground w-full">Authorized personnel only. All activity is logged.</p>
            </CardFooter>
          </Card>
        </div>
      </main>
