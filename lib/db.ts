...
async function initSchema() {
  ...
  `
  await sql`ALTER TABLE newsletters ADD COLUMN IF NOT EXISTS download_name VARCHAR(255) NOT NULL DEFAULT ''`
  await sql`ALTER TABLE newsletters ADD COLUMN IF NOT EXISTS description TEXT NOT NULL DEFAULT ''`
